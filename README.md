...
I have also tried "Pick model"  as described in [paper:] (https://arxiv.org/abs/2004.07464). The result performes better. It needs at least 10GB GPU memory and costs more time to train.   
